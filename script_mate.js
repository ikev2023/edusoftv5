...
function borrar() {
  localStorage.removeItem("av_mate");
  localStorage.removeItem("punteoquiz2");
  location.reload();
}
...
function seguir1() {
  avance = 1;
  localStorage.setItem("av_mate", avance.toString());
  console.log(avance);
  location.reload();
}
function seguir2() {
...
function seguir5() {
  ...
  let objeto2 = localStorage.getItem("punteoquiz2");
  if (objeto2) {
...
function responder5() {
  ...
  if (document.getElementById("correcta5").checked) {
    ...
    alert("respuesta correcta :D");
    document.getElementById("pregunta5").style.display = 'none';
    localStorage.setItem("punteoquiz2", punteo.toString());
    mostrarAlerta5();
  }
  else {
    alert("respuesta Incocrrecta :C");
